...
from edatasheets_creator.drivers.data_table_pdg import DataTablePDGCCG
...
class Plugin:
    def process(self, inputFileName, outputFileName, mapFileName=""):
        ...
        try:
            ...
            msg = "DITA to JSON for PDG Checker Plugin is loaded...\n"
            ExceptionLogger.logInformation(__name__, msg)
            data_table = DataTablePDGCCG(inputFileName, outputFileName)
